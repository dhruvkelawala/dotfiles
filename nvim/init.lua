...
local on_attach = function(_, bufnr)
  ...
  vim.api.nvim_set_keymap('n', '<leader>ff', ':NvimTreeFindFile<cr>', { silent = true, noremap = true })
...
require("debugprint").add_custom_filetypes({
  ["javascript"] = js_override,
  ["typescript"] = js_override,
  ["javascriptreact"] = js_override,
  ["typescriptreact"] = js_override
})
